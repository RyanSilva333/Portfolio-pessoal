            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item" href="./index.php">Funcionário</a></li>
    ...
    <header>
      <div class="titulo-header">
          ...
          <h4 class="desc-empresa">
            Cadastro de <strong>Funcionário </strong>
          </h4>
      </div>
  </header>
    <div class="conteudo-meio">
        <div class="conteudo-lista">
            <form action="#" method="post">
                <label>Nome</label>
                <input type="text" placeholder="Nome" name="nomeFunc" id="Nome" oninput="atualizeRG(this)">
                
                <label>CPF</label>
                <input type="number" placeholder="CPF" name="cpfFunc" id="CPF" maxlength="14">

                <label>RG</label>
                <input type="number" placeholder="RG" name="rgFunc" id="RG">



                <div class="consulta-CEP">
                    <label class="label-CEP">CEP</label><br>
                    <input name="cepFunc" type="text" name="cepFunc" id="cep" size="10" maxlength="9" onblur="pesquisacep(this.value);" placeholder="CEP"/>
                    <br>
                    <label class="label-CEP">Rua</label><br>
                    <input name="rua" type="text" id="rua" size="60" />

                    <label class="label-CEP">Nº</label><br>
                    <input name="numFunc" type="number" id="#" />
                ...
                <label>Celular</label>
                <input type="text" name="celFunc" placeholder="Celular">

                <label>Email</label>
                <input type="text" name="gmailFunc" placeholder="Email">

                <label>Data de Admissão</label>
                <input name="dateFunc" type="date">
                <hr>
...
if(!empty($_POST)){
  $nome = $_POST['nomeFunc'];
	...
	$celular = $_POST['celFunc'];
	$email = $_POST['gmailFunc'];
  $date_admissao = $_POST['dateFunc'];

	include_once('conexao.php');

  try{
    $stmt = $conn->prepare("INSERT INTO funcionario (nome,cpf,rg,cep,numero,celular,email, data_admissao) VALUES (:nome,:cpf,:rg,:cep,:numero,:celular,:email,:data_admissao)");
    ...
    $stmt->bindParam(':data_admissao', $date_admissao);
