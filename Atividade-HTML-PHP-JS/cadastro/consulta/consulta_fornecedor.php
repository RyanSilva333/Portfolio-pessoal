...
<button class='btn btn-primary' onclick="window.location.href='alterarFornec.php?id=<?php echo $row['codigo']; ?>'">
    Alterar
</button>

<button class='btn btn-danger' onclick="window.location.href='excluirFornecedor.php?id=<?php echo $row['codigo']; ?>'">
    Excluir
</button>
