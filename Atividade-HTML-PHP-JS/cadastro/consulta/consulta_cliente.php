...
<button class='btn btn-primary' onclick="window.location.href='alterarCliente.php?id=<?php echo $row['codigo']; ?>'">
    Alterar
</button>

<button class='btn btn-danger' onclick="window.location.href='excluirCliente.php?id=<?php echo $row['codigo']; ?>'">
    Excluir
</button>
