...
<button class='btn btn-primary' onclick="window.location.href='alterarProduto.php?id=<?php echo $row['codigo']; ?>'">
    Alterar
</button>

<button class='btn btn-danger' onclick="window.location.href='excluirProduto.php?id=<?php echo $row['codigo']; ?>'">
    Excluir
</button>
