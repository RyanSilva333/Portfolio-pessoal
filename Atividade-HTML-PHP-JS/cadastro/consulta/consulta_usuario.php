...
<button class='btn btn-primary' onclick="window.location.href='alterarUsuario.php?id=<?php echo $row['codigo']; ?>'">
    Alterar
</button>

<button class='btn btn-danger' onclick="window.location.href='excluirUsuario.php?id=<?php echo $row['codigo']; ?>'">
    Excluir
</button>
