<html>
	...
	<?php
	 ...
	 ?>
		<form action="confirmaAlterarFornec.php" method="POST">
				...
				<div class="row">
    				...
    				<div class="col">
      					<div class="mb-3">
							...
							<input type="text" placeholder="CPF do Cliente" class="form-control" name="cnpj" required maxlength="11" value="<?php echo $row['cnpj'];?>"
							onkeypress='return event.charCode >= 48 && event.charCode <= 57'  
							onblur="alert(TestaCPF(this.value));">
							
							<label for="cRG"><b>I.E</b></label>
							<input type="text" placeholder="RG do Cliente" class="form-control" name="ieFornecedor" value="<?php echo $row['ie'];?>" required>
							...
							<div class="text-center">
								...
								<button type="button" class="btn btn-success" onclick="javascript: location.href='consultaCliente.php'">Voltar</button>
							</div>
						</div>
  					</div>
  					<div class="col">
