        ...
        <div class="form-content">
            <form action="#" method="POST" class="form-login">
                ...
                <div class="buttons-content">
                    <label class="Version">Versão: 1.0.0</label>
...
if (!empty($_POST)) {
    ...
    $rs = $conn->query("SELECT * FROM usuario WHERE nomeUsuario='$usuario' AND senhaUsuario='$senha'");

    $rs->execute();

    if ($rs->fetch(PDO::FETCH_ASSOC) == true) {
        $_SESSION['login'] = $usuario;
        header('Location:cadastro/Menu/index.php');
    } else {
        echo "<script>";
